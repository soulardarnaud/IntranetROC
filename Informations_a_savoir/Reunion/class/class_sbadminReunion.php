                    ...
                    <ul class="nav navbar-nav side-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="../../NotreDameduRoc/Personnels/personnels.html">Les personnels</a></li>
                                <li><a href="../../NotreDameduRoc/Formations/formations.html">Les formations</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="../Matériel/matériel.html">Matériel</a></li>
                                <li><a href="../Rappels/rappels.html">Quelques rappels de rentrée</a></li>
                                <li><a href="../Self/self.html">Self</a></li>
                                <li><a href="../Absences/absences.html">Que faire en cas d'absences ?</a></li>
                                <li><a href="https://docs.google.com/spreadsheet/viewform?formkey=dDFVMHNkdTlVQ3lJc19UM29Ia1BSR3c6MQ">Ordre de mission</a></li>
                                <li><a href="../SEPA/sepa.html">Mandat de prélèvement SEPA</a></li>
                                <li><a href="réunion.html">Réunion</a></li>
                            </ul>
                        </li>
                        <!-- Informatique -->
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="../../Informatique/Maintenance/maintenance.html">Pannes Informatiques </a></li>
